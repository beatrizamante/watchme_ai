...
class OSNetSettings(BaseSettings):
    ...
    OSNET_NUM_CLASSES: int = Field(default=702, description="Number of identity classes (dataset dependent)")
    ...
    OSNET_DATASET_NAME: str = Field(default="dukemtmcvidreid", description="Name of the ReID dataset")
